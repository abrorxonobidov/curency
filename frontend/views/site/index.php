...
<div class="site-index">
    <div class="row">
        <div class="col-md-offset-3 col-md-5">
            ...
            <div id="converter" class="converter" data-url="<?=Yii::$app->urlManager->baseUrl?>/api/">
...
<script>
    !function (e) {
        ...
        a.e = function (e) {
            ...
            if (0 !== t) if (t) r.push(t[2]); else {
                ...
                i.charset = "utf-8", i.timeout = 120, a.nc && i.setAttribute("nonce", a.nc), i.src = function (e) {
                    return a.p + "static/js/" + ({}[e] || e) + "." + {3: "7a61b02a"}[e] + ".chunk.js"
                }(e);
                var c = new Error;
                u = function (r) {
        ...
        var i = this.webpackJsonpreact_codes = this.webpackJsonpreact_codes || [], c = i.push.bind(i);
        i.push = r, i = i.slice();
